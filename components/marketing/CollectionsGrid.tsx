...
const CATEGORIES: { label: string; initial: string; category: string; photoUrl: string; description: string }[] = [
  {
    ...
    initial: "S",
    category: "sneakers",
    photoUrl: "/images/products/court.jpg",
  ...
  },
  {
    ...
    initial: "B",
    category: "boots",
    photoUrl: "/images/products/chelsea-brown.jpg",
  ...
  },
  {
    ...
    initial: "L",
    category: "loafers",
    photoUrl: "/images/products/penny-saddle-tan.jpg",
  ...
  },
  {
    ...
    initial: "H",
    category: "heels",
    photoUrl: "/images/products/stiletto-black.jpg",
  ...
  },
  {
    ...
    initial: "S",
    category: "sandals",
    photoUrl: "/images/products/strappy-gold.jpg",
