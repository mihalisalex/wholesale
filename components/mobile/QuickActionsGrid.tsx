...
const ACTIONS = [
  ...
  {
    href: "/catalog?isNewArrival=true",
    label: "New Arrivals",
    sub: "Just landed this season",
    icon: <path d="M12 3v14M12 3l5 5M12 3 7 8M5 21h14" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />,
  },
  {
    href: "/quick-order",
    label: "Quick Order",
